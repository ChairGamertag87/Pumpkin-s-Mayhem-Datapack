...
execute if items entity @s weapon.mainhand minecraft:warped_fungus_on_a_stick[custom_data={eqpumpkin:1b}] run function game:pumpkin/thunder_pumpkin/pumpkin_launch
