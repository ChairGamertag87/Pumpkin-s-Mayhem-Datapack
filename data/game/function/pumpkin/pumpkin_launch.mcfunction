...
execute positioned ~ ~1 ~ run summon minecraft:armor_stand ^ ^1.6 ^1 {Tags:["temp_snowball_pumpkin"],Motion:[0.0,0.0,0.0]}
...
summon minecraft:item_display ^ ^1.6 ^1 {Tags:["pumpkin"],NoGravity:1b,billboard:"fixed",item_display:"fixed",interpolation_duration:5,interpolation_delay:0,teleport_duration:0,transformation:{scale:[0.5f,0.5f,0.5f]},item:{id:"minecraft:pumpkin",Count:1b}}
