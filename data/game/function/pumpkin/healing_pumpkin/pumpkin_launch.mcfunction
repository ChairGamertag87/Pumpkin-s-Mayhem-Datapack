...
summon minecraft:item_display ^ ^1 ^1 {Tags:["pumpkin","hpumpkin"],NoGravity:1b,billboard:"fixed",item_display:"fixed",interpolation_duration:5,interpolation_delay:0,teleport_duration:0,transformation:{scale:[0.5f,0.5f,0.5f]},item:{id:"minecraft:pumpkin",count:1}}
