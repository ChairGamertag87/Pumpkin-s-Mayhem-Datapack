...
execute positioned ~ ~ ~ run summon minecraft:armor_stand ^ ^1 ^1 {Tags:["temp_snowball_pumpkin","darkpumpkin"],Motion:[0.0,0.0,0.0],Invulnerable:1b,Small:1b,Invisible:1b}
